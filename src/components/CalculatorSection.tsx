...
type CalcSubTab = "buying" | "selling" | "conversion";
  ...
  return (
    <div className="calc-tabs">
      <nav className="subtab-bar">
        ...
        <button
          className={`subtab ${subTab === "conversion" ? "subtab-active" : ""}`}
      ...
      {/* All three panels stay mounted at all times — only visibility toggles
          via CSS — so switching sub-tabs never resets in-progress input. */}
      ...
      <div className={subTab === "conversion" ? "" : "calc-panel-hidden"}>
        <ConversionSection />
      </div>
    </div>
  );
